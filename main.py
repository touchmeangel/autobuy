...
app = Client("session", device_model="Chrome 141 @touchmeh", client_platform=ClientPlatform.DESKTOP, app_version="12.0.4", api_id=api_id, api_hash=api_hash, workdir=workdir)
